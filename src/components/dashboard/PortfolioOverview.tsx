                ...
                return (
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={currentChart.data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                            ...
                            <YAxis stroke="rgba(255,255,255,0.3)" style={{ fontSize: '12px' }} tickFormatter={(value) => `$${value/1000}k`} />
                            <RechartsTooltip 
                                formatter={(value: number) => new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(value)}
                ...
                return (
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={currentChart.data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                            ...
                            <YAxis axisLine={false} tickLine={false} tick={{fill: 'rgba(255,255,255,0.3)', fontSize: 10, fontWeight: 'bold'}} tickFormatter={(value) => `$${value/1000}k`} />
                            <RechartsTooltip 
                                formatter={(value: number) => new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(value)}
    ...
    return (
        <div className="flex flex-col h-full space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold font-serif text-white tracking-tight">Your Portfolio</h2>
                    <p className="text-white/50 text-sm mt-1">Holistic view of your retirement architecture.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass-premium border border-white/5 bg-white/[0.02] rounded-[32px] p-6 flex flex-col justify-center relative shadow-lg group">
                ...
                <div className="glass-premium border border-white/5 bg-white/[0.02] rounded-[32px] p-6 flex flex-col justify-center relative shadow-lg group">
                    ...
                    <div className="text-3xl font-bold font-serif text-white">
                        $0<span className="text-lg text-white/30 font-sans">/mo</span>
                    </div>
                </div>
            ...
            {/* Main Chart Area */}
            <div className="flex-1 glass-premium border border-white/5 bg-white/[0.02] rounded-[32px] p-8 relative flex flex-col min-h-[450px]">
                
                <div className="flex items-center justify-between mb-8">
                    <h3 className="text-xl font-bold font-serif text-white">{currentChart.title}</h3>
                </div>
